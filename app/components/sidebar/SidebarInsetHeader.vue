...
import Palette from '../command/Palette.vue';
import ReportErrorsShortcut from '../dialogs/ReportErrorsDialog.vue';
import RouterAutoBreadcrumb from '../breadcrumb/RouterAutoBreadcrumb.vue';
